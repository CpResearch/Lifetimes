...
void aaa(TTree* T, TH2F* h2, vardata v, const char** cut_str){
	// cout << *cut_str << endl;
	h2 -> Reset();
...
void multivar_optim(){
	...
	vardata v1 = vars::bkmm_jpsimc_alpha;
	vardata v2 = vars::bkmm_kaon_pt;
	// cout << v.prettyName << endl;
	// cout << "Analyzing branch: " << branch_name << endl;
	// TCanvas* canvas = new TCanvas();

	TH2F* h2_1 = new TH2F("h2_1", "thingy", 100, 4.9, 5.8, 100, v1.cutLower, v1.cutUpper);
	TH2F* h2_2 = new TH2F("h2_2", "thingy", 100, 4.9, 5.8, 100, v2.cutLower, v2.cutUpper);
	// TH2F* h2 = new TH2F("h2", "thingy", 10, 4.9, 5.8, 10, 0, 50);
	// TH2F hScore("hScore", "hi", 100, 4.9, 5.8, 20, 13, 25);
	const char* cut_str = "2 > 1";
